...
(function () {
  ...
  var EN = {
    ...
    gameGo: "Play →",
    tagStory: "FILM + SCROLLING TIMELINE", storyH: "From a single egg",
    storyB: "From one remark in 1987 to the world's first full-cycle farming, Japan's first caviar, and on to the fortieth year in 2027. First, a one-minute film shows a single egg becoming Fujie. Then, in the timeline, forty years go past under one thumb. It is written as a story rather than a company history. People come away liking a valve company.",
    storyGo: "Read →",
