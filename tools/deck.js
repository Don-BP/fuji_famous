...
body(s, "アクアワールド茨城県大洗水族館はサメの展示で知られています。その隣に本物の展示水槽をひとつ設け、里美養魚場から来たフジィを何尾も泳がせます。パネルの一言は「サメじゃないです。サメより、ずっと少ないんです」。誰もがサメだと思う魚を、本物のサメの隣に。これ以上わかりやすい入口はありません。水族館の判断が前提の提案です。", { x: M, y: 2.35, w: 11.8, h: 1.5, fontSize: 13 });
const pts7 = [
